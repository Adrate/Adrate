...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { cost: @advertisement.cost, description: @advertisement.description, enddate: @advertisement.enddate, startdate: @advertisement.startdate }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { cost: @advertisement.cost, description: @advertisement.description, enddate: @advertisement.enddate, startdate: @advertisement.startdate }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
